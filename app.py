...
if response_text.startswith(”`json"): response_text = response_text[7:] if response_text.endswith("`”):
...
1. Identify specific gaps between this content and high-performers
1. Calibrate scores based on what actually drives results
1. Provide recommendations based on proven patterns
1. Reference specific successful examples when making suggestions
...
1. Promise Structure: Is there a clear value proposition? How well does it create anticipation?
1. Content Delivery: Does the video fulfill its promise? Is the pacing engaging?
1. Visual-Audio Synergy: How do the visual and audio elements work together?
1. Retention Design: What keeps viewers watching? Where might they drop off?
1. Algorithmic Factors: What might be hurting algorithmic distribution?
1. Knowledge Base Alignment: How does this compare to successful strategies in your knowledge?
